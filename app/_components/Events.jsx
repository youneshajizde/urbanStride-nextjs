...
function Events() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-4 md:h-[380px] mt-6">
      ...
      <div className="md:col-span-1 h-[300px] md:h-auto bg-gray-300 p-4 rounded-3xl relative ">
        ...
        <div className="relative px-0 flex flex-col gap-4  ">
          ...
          <p className="text-white hidden md:block">
            Join the sneaker fest on 2025 on 2th october, We have more fun gigs
            too and supported by urbanStride
          </p>
        </div>
        <div className="w-20 absolute bottom-5">
