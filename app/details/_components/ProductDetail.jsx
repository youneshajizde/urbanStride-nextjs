...
function ProductDetail() {
  const [selectedSize, setSelectedSize] = useState(38); // Default size is 38

  const sizes = [38, 39, 40, 42];
            ...
            <div className="flex items-center gap-4 mt-4">
              {sizes.map((size) => (
                <span
                  ...
                  className={`cursor-pointer relative w-[120px] flex items-center justify-center bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-lg text-white font-semibold text-lg ${
